...
#include "sweetScene.h"
//--------------------------------------------------------------
void sweetTestApp::setup(){
...
//--------------------------------------------------------------
void sweetTestApp::keyPressed  (int key){
}

//--------------------------------------------------------------
void sweetTestApp::keyReleased  (int key){
}

//--------------------------------------------------------------
void sweetTestApp::mouseMoved(int x, int y ){
}

//--------------------------------------------------------------
void sweetTestApp::mouseDragged(int x, int y, int button){
}

//--------------------------------------------------------------
void sweetTestApp::mousePressed(int x, int y, int button){
}

//--------------------------------------------------------------
void sweetTestApp::mouseReleased(){
}
